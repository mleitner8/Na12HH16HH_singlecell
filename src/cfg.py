...
cfg.analysis['plotTraces'] = {'saveFig': True, 'ylim':[-80, 40], 'fontSize': 16} # Plot Traces
...
cfg.IClamp1 = {'pop': 'PT5B' ,'sec': 'soma', 'loc': 0.5, 'start': 100, 'dur': 500, 'amp': 0.5}
...
cfg.NetStim1 = {'pop': 'PT5B', 'sec': 'dend_73', 'loc': 0.5, 'synMech': ['AMPA', 'NMDA'], 'synMechWeightFactor': [0.5, 0.5],
